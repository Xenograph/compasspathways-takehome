...
describe('Paginator', () => {
  it('displays the current page number', () => {
    (useSearchParams as jest.Mock).mockReturnValue({get: () => '7', entries: () => [['page', '7']]});
  ...
  it('does not display previous page button when on first page', () => {
    (useSearchParams as jest.Mock).mockReturnValue({get: () => '1', entries: () => [['page', '1']]});
    render(<Paginator more={false} paramName='page'/>)
  ...
  it('displays previous page button when not on first page', () => {
    (useSearchParams as jest.Mock).mockReturnValue({get: () => '2', entries: () => [['page', '2']]});
    render(<Paginator more={false} paramName='page'/>)
